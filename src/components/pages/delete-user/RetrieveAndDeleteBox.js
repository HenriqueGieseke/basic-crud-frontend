...
import UpdateUsersContainer from '../update-user/UpdateUsersContainer';
import DeleteUserView from './DeleteUserView';

const RetrieveAndDeleteBox = () => {
  ...
  if (userFound) {
    return (
      <Container>
        <DeleteUserView user={userToDelete} />
        <DatabaseInfoBox />
      </Container>
    );
  } else if (notFound) {
      ...
      <Container>
        <ContentBox>
          ...
          <UpdateUsersContainer
            found={setUserFound}
            setUserToUpdate={setUserToDelete}
            users={users}
            isLoading={isLoading}
          />
        </ContentBox>
...
export default RetrieveAndDeleteBox;
